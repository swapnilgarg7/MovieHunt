...
function About() {
    return (
        <div className='mx-6 space-y-6'>
            ...
            <p className='text-lg'>
                This is a website that helps movie enthusiasts find a Movie or TV Show to watch.
                It provides a list of movies and TV shows that are currently trending and top rated.
            ...
            <p className='text-lg'>
                This website was implemented with Next.js, Tailwind CSS, IMDb API.
